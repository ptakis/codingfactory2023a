...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/tmp/lotto5in.txt"));
            ...
            int[] numbers = Arrays.copyOfRange(inputNumbers, 0, pivot); // Αντιγράφει απο 0 έως pivot - 1
            Arrays.sort(numbers);
    ...
    /**
     * Returns tru if the number of evens is greater than or
     ...
     * @return
     *      true if the number of evens is greater than or equal
